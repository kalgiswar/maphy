...
const MainPage = () => {
  ...
  const getDetails = async () => {
    const url = `${Domain}/hardware?manufacturer_id=${id}&limit=${sizePerPage}&offset=${offset}&search=${searchText}&sort=${sortField}&order=${sortOrder}`;
    try {
                ...
                <Table>
                  <thead>
                    <tr>
                      ...
                      <th onClick={() => onTableChange("model.name")}>
