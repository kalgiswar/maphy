  ...
  const getDetails = async () => {
    try {
      const response = await axios.get(
        `${Domain}/hardware?model_id=${id}&limit=${sizePerPage ? sizePerPage : 10
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item>
                        ...
                        <button
                          ...
                          onClick={() => navigate("/addEditAssetModels")}
                        >
                      ...
                      <Dropdown.Item>
                        <button
                          type="button"
                          className="btn btn-link"
                          onClick={() => navigate(`/addEditAssetModels/${id}`)}
                        >
                      ...
                      <Dropdown.Item>
                        <button
                          ...
                          className="btn btn-link"
                          onClick={() =>
                            navigate(`/addEditAssetModels/${id}`, {
                              state: { mode: "clone" },
                            })
                          }
                        >
                  ...
                  <div className="my-3">
                    <Form>
                      ...
                      <CsvExportButton
                        headers={[
                          t("Asset.assetname"),
                          t("AssetsListall.asset"),
                          t("AssetsListall.serial"),
                          t("Asset.category"),
                          t("Asset.status"),
                          t("Asset.checkout_to"),
                          t("Asset.location"),
                          t("Asset.defaultlocation"),
