...
const MainPage = () => {
  ...
  const getDetails = async () => {
    let url;
    if (pageType === "assignedTo") {
      url = `${Domain}/hardware?assigned_to=${id}&checkout_to_type=location&limit=${sizePerPage}&offset=${offset}&search=${searchText}&sort=${sortField}&order=${sortOrder}`;
    } else {
      url = `${Domain}/hardware?location_id=${id}&limit=${sizePerPage}&offset=${offset}&search=${searchText}&sort=${sortField}&order=${sortOrder}`;
    }
    try {
                    ...
                    <Form>
                      ...
                      <CsvExportButton
                        headers={[
                          ...
                          t("AssetsListall.update_at"),
                        ]}
                        data={csvData}
                        filename="LocationListall.csv"
                      />
                    </Form>
                  </div>
                </div>
