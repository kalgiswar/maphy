          ...
          <Col md={12}>
            <div>
              <div className="title d-flex justify-content-between">
                <div>
                  <h1>{t("reports.Depreciationname")}</h1>
                </div>
              </div>
              <div className="dataTable wrapper">
                <div className="d-flex justify-content-between">
                  <div className="my-3">
                    <Form>
                      ...
                      <CsvExportButton
                        headers={[
                          t("reports.Depreciationname"),
                          t("reports.term"),
                        ]}
                        data={csvData}
                        filename="Depreciationreports.csv"
                      />
                    </Form>
                  </div>
                </div>
                <div className="table-container">
                  <Table>
                    <thead>
                      <tr>
                        <th onClick={() => onTableChange("Depreciationname")}>
                          {t("reports.Depreciationname")}
                          <SortingIcon
                            columnName="Depreciationname"
                            sortField={sortField}
                            sortOrder={sortOrder}
