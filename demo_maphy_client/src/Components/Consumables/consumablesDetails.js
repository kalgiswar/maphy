...
const ConsumablesLink = () => {
  ...
  const getDetails = async () => {
    var url =
      Domain +
      `/consumables/view/${id}/users?limit=${
                ...
                <Table>
                  <thead>
                    <tr>
                      ...
                      <th> {t("consumable.date")}</th>
                      <th> {t("consumable.admin")} </th>
                    </tr>
                  </thead>
                  <tbody>
                    {data?.length > 0 ? (
...
export default ConsumablesLink;
